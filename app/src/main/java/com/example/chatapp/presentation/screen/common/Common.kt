...
import com.example.chatapp.util.Constants.CLIENT_ID
...
//                will set whether the google ID token credential should be returned by the google whenever we authenticate
                .setSupported(true)
//                will set the server's client ID to use as a audience for google ID token generated during SignIn
//                audience is a imp. claim for JWT, which is used to verify for which audience that a specific ID token is generated
